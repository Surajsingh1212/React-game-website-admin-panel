                      ...
                      <div className="col-xl-6 col-lg-6 col-md-8">
                          <div className="main-content">
                              <div className="top-area section-text">
                                  ...
                                  <h1 className="title" style={{fontSize:'4rem',color:'white'}}>Next Level <span>Crypto Gaming</span> Platform</h1>
                  ...
                  <div className="row cus-mar">
                      <div className="col-lg-6 col-md-6">
                          <div className="single-box d-flex align-items-center">
                              ...
                              <div className="text-area">
                                  <h5 style={{color:'white'}}>Weekly Draw Prizes</h5>
                      ...
                      <div className="col-lg-6 col-md-6">
                          <div className="single-box second d-flex align-items-center">
                              ...
                              <div className="text-area">
                                  <h5 style={{color:'white'}}>Paid Overall</h5>
